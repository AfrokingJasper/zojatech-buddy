...
export default function Login() {
  ...
  const emailInputStyle = (field: string) =>
    `w-full h-[40px] pl-11 pr-12 py-3 rounded-xl border bg-white dark:bg-[#13141a] text-[#1D1D18] dark:text-white font-sans text-sm focus:outline-none transition-all duration-200 hover:bg-[#FFF9F2] dark:hover:bg-[#FF8600]/5 hover:border-primary/50 ${errors[field]
    ...
    <div className="w-full max-w-[489px] p-[50px] mx-auto bg-white dark:bg-[#181920] border border-[#DDE2E4] dark:border-[#2e303a]/60 rounded-2xl shadow-[10px_50px_50px_rgba(0,0,0,0.059)] dark:shadow-[10px_50px_50px_rgba(0,0,0,0.25)] transition-all duration-300">
      <div className='flex flex-col gap-[64px] w-[389px] h-[420px]'>
          ...
          <div className='flex flex-col gap-[16px]'>
            ...
            <form onSubmit={handleSubmit} className="space-y-[30px]">
              <div className='flex flex-col gap-[25px]'>
                ...
                <div className="group relative pt-5">
                  <div className={`relative w-full h-[40px] rounded-xl border bg-white dark:bg-[#13141a] transition-all duration-200 hover:bg-[#FFF9F2] dark:hover:bg-primary/5 hover:border-primary/50 ${errors.password
                    ...
                    <div className="absolute left-11 right-12 top-1/2 -translate-y-1/2 h-[20px] overflow-hidden">
                      <input
                        ...
                        className={`absolute text-[1rem] inset-0 w-full h-full border-none bg-transparent p-0 outline-none focus:outline-none focus:ring-0 text-text-thick dark:text-white font-sans text-sm transition-transform ease-in-out duration-300 ${showPassword ? '-translate-y-full' : 'translate-y-0'
                          }`}
                      />
                      ...
                      <input
                        ...
                        aria-hidden={!showPassword}
                        className={`absolute text-text-main inset-0 text-[0.875rem] w-full h-full border-none bg-transparent p-0 outline-none focus:outline-none focus:ring-0 dark:text-white font-sans text-sm transition-transform ease-in-out duration-300 ${showPassword ? 'translate-y-0' : 'translate-y-full'
                          }`}
                      />
                    </div>

                    <label
                      className={`text-[0.875rem] absolute pointer-events-none transition-all duration-350 ease-in-out font-sans select-none z-20 ${focusedFields.password || password !== ''
              ...
              <button
                ...
                className={`w-full py-3.5 px-4 h-[40px] rounded-xl font-semibold text-sm transition-all duration-200 flex items-center justify-center gap-2 ${!isFilled
        ...
        <div className="text-left text-[0.875rem] text-text-main dark:text-gray-400 font-sans">
          ...
          <Link to="/signup" className="text-primary font-semibold hover:underline transition-colors">Register</Link>
        </div>
      </div>
    </div>
  );
